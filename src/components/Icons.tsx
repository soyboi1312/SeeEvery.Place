...
export function BlueskyIcon({ className = "w-6 h-6" }: { className?: string }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 512 512"
...
export function FacebookIcon({ className = "w-6 h-6" }: { className?: string }) {
  return (
    <svg
      ...
      className={className}
    >
      <path d="M9.101 23.691v-7.98H6.627v-3.667h2.474v-1.58c0-4.085 1.848-5.978 5.858-5.978.401 0 .955.042 1.468.103a8.68 8.68 0 0 1 1.141.195v3.325a8.623 8.623 0 0 0-.653-.036c-2.148 0-2.797 1.603-2.797 2.898v1.074h3.44l-.615 3.667h-2.824v7.98c-1.343.37-2.76.657-4.219.657-1.46 0-2.877-.287-4.219-.657Z" />
    </svg>
  );
}

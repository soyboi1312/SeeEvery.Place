...
const DATA_LOADERS: Record<Category, () => Promise<any[]>> = {
  ...
  euroFootballStadiums: () => import('@/data/stadiums').then(m => m.getEuroFootballStadiums()),
  rugbyStadiums: () => import('@/data/stadiums').then(m => m.getRugbyStadiums()),
  cricketStadiums: () => import('@/data/stadiums').then(m => m.getCricketStadiums()),

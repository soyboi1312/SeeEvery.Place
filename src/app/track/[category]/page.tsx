...
const categoryExamples: Record<Category, PlaceExample[]> = {
  ...
  territories: [
    ...
    { name: 'Midway Atoll', fact: 'Site of the pivotal 1942 Battle of Midway that turned the tide of WWII in the Pacific. Today it\'s home to the world\'s largest colony of Laysan albatrosses—over a million birds nest here annually.', reason: 'Witness one of nature\'s most spectacular gatherings as albatrosses fill every inch of the island. See endangered Hawaiian monk seals basking on pristine beaches and walk among historic WWII bunkers in this remote wildlife sanctuary.' },
  ...
  museums: [
    ...
    { name: 'British Museum, London', fact: 'Houses 8 million objects spanning 2 million years of history, yet only 1% are on display at any time. The museum has been free to enter since opening in 1759—the world\'s first national public museum.', reason: 'See the actual Rosetta Stone that unlocked Egyptian hieroglyphics and walk among mummies from ancient Egypt. Explore the controversial Elgin Marbles, examine samurai armor, and travel through human civilization without spending a penny.' },
  ...
  surfingReserves: [
    { name: 'Banzai Pipeline, Hawaii', fact: 'The most famous and dangerous wave in surfing breaks over a shallow reef just 3-5 feet below the surface—wipeouts here can be fatal. Pipeline has killed more surfers than any other wave yet remains the ultimate proving ground for professionals.', reason: 'Witness the most famous wave in surfing where careers are made and legends are crowned. Watch from the beach as the world\'s best challenge barrels that can either make you a champion or put you in the hospital. Even spectating Pipeline is a bucket-list experience.' },
  ...
  weirdAmericana: [
    ...
    { name: 'Corn Palace, South Dakota', fact: 'The only palace in the world decorated with corn—exterior murals made entirely from corn and grain are redesigned and reapplied every single year. The building has served as the town\'s auditorium since 1892.', reason: 'See the world\'s only palace decorated with thousands of ears of corn in intricate designs that change annually. Watch artisans apply this year\'s corn mosaic, attend events in the auditorium, and appreciate the agricultural pride that keeps this tradition alive.' },

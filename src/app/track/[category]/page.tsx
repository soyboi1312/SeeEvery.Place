      ...
      <main className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-100 dark:border-gray-700 text-center">
            ...
            <h3 className="font-bold text-gray-800 dark:text-gray-100 mb-2">Interactive Map</h3>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-100 dark:border-gray-700 text-center">
            ...
            <h3 className="font-bold text-gray-800 dark:text-gray-100 mb-2">Bucket List</h3>
            <p className="text-gray-600 dark:text-gray-400 text-sm">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-100 dark:border-gray-700 text-center">
            <div className="text-3xl mb-3">📤</div>
            <h3 className="font-bold text-gray-800 dark:text-gray-100 mb-2">Share Stats</h3>
            <p className="text-gray-600 dark:text-gray-400 text-sm">
        ...
        <section className="mt-16">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            {categoryExamples[category as Category]?.map((example, index) => (
              ...
              >
                <h3 className="font-bold text-gray-800 dark:text-gray-100 text-lg mb-2">{example.name}</h3>
                <div className="space-y-2">
                  <p className="text-gray-600 dark:text-gray-400 text-sm">
                    <span className="font-medium text-blue-600 dark:text-blue-400">Unique fact:</span>{' '}
                    {example.fact}
                  </p>
                  <p className="text-gray-600 dark:text-gray-400 text-sm">
                    <span className="font-medium text-purple-600 dark:text-purple-400">Why visit:</span>{' '}
                    {example.reason}
                  </p>
                </div>
              </div>
            ...
            {categories
              ...
              .map((c) => (
                <Link
                  key={c}
                  href={`/track/${c}`}
                  className="bg-white dark:bg-gray-800 rounded-lg p-4 shadow-sm border border-gray-100 dark:border-gray-700 hover:shadow-md transition-all text-center"
                >
                  <span className="text-2xl block mb-2">{categoryIcons[c]}</span>
                  <span className="text-sm font-medium text-gray-700 dark:text-gray-300">{categoryLabels[c]}</span>
                </Link>
              ))}
          </div>
        </section>

...
const categoryExamples: Record<Category, PlaceExample[]> = {
  ...
  usCities: [
    { name: 'New York City', fact: 'Has 520 miles of subway track, the most extensive metro system in the US', reason: 'Experience Broadway, Central Park, and world-class museums' },
    { name: 'San Francisco', fact: 'The Golden Gate Bridge contains enough wire to circle the Earth 3 times', reason: 'Ride cable cars and explore diverse neighborhoods' },
    { name: 'Chicago', fact: 'Home to the first ever skyscraper, built in 1885', reason: 'Admire stunning architecture and deep-dish pizza' },
    { name: 'New Orleans', fact: 'The only US city with its own cuisine style - Creole', reason: 'Experience jazz, beignets, and Mardi Gras culture' },
    { name: 'Las Vegas', fact: 'Has over 200,000 hotel rooms, more than any other city', reason: 'See world-class entertainment and iconic neon lights' },
    { name: 'Seattle', fact: 'Gets less annual rainfall than New York City or Miami', reason: 'Visit Pike Place Market and see the original Starbucks' },
    { name: 'Austin', fact: 'Known as the Live Music Capital of the World with 250+ venues', reason: 'Experience SXSW culture and amazing Tex-Mex food' },
  ],
  worldCities: [
    { name: 'Tokyo', fact: 'Has more Michelin-starred restaurants than any other city in the world', reason: 'Experience cutting-edge technology and ancient traditions' },
    { name: 'Paris', fact: 'The Eiffel Tower grows up to 6 inches taller in summer due to heat expansion', reason: 'Visit world-class museums and iconic landmarks' },
    { name: 'London', fact: 'Has over 170 museums, many of which are free to enter', reason: 'Explore centuries of history and modern culture' },
    { name: 'Rome', fact: 'Has a sovereign country (Vatican City) entirely within its borders', reason: 'Walk through 2,500 years of history and art' },
    { name: 'Singapore', fact: 'Changi Airport has a butterfly garden and the world\'s tallest indoor waterfall', reason: 'Experience the world\'s most futuristic city-state' },
    { name: 'Dubai', fact: 'Has the world\'s tallest building, largest mall, and deepest pool', reason: 'See record-breaking architecture and luxury experiences' },
    { name: 'Sydney', fact: 'The Sydney Opera House roof is covered with over 1 million tiles', reason: 'Visit iconic landmarks and beautiful beaches' },
  ],
  nationalParks: [

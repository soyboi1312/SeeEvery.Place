    ...
    return (
      <div className="min-h-screen bg-gradient-to-b from-blue-50 to-purple-50 dark:from-gray-900 dark:to-gray-800">
        ...
        <main className="max-w-2xl mx-auto px-4 py-16 text-center">
          ...
          <p className="text-gray-600 dark:text-gray-300 mb-6">You need to be signed in to access settings.</p>
          <Link
            href="/"
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-purple-50 dark:from-gray-900 dark:to-gray-800">
      ...
      <main className="max-w-2xl mx-auto px-4 py-8">
        ...
        <p className="text-gray-600 dark:text-gray-300 mb-8">Manage your account and data</p>
        ...
        <section className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-100 dark:border-gray-700 mb-6">
          ...
          {/* Export Data */}
          <div className="mb-6">
            <h4 className="font-medium text-gray-800 dark:text-gray-200 mb-2">Export Your Data</h4>
          ...
          {/* Privacy Policy Link */}
          <div>
            <h4 className="font-medium text-gray-800 dark:text-gray-200 mb-2">Privacy Policy</h4>
            <p className="text-sm text-gray-600 dark:text-gray-400 mb-3">

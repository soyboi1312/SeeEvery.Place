    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-purple-50 dark:from-gray-900 dark:to-gray-800">
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        <article className="prose prose-lg max-w-none">
          <h1 className="text-4xl font-bold text-gray-800 dark:text-white mb-6">Terms of Service</h1>
          ...
          <section className="mb-10">
            <h2 className="text-2xl font-bold text-gray-800 dark:text-white mb-4">4. User-Generated Content</h2>
            <p className="text-gray-600 dark:text-gray-300 mb-4">
              When you submit content to See Every Place™ (including category suggestions, feedback, or other contributions):
            </p>
          ...
          <section className="mb-10">
            <h2 className="text-2xl font-bold text-gray-800 dark:text-white mb-4">5. Prohibited Uses</h2>
          ...
          <section className="mb-10">
            <h2 className="text-2xl font-bold text-gray-800 dark:text-white mb-4">6. Account Termination</h2>
            <p className="text-gray-600 dark:text-gray-300 mb-4">
          ...
          <section className="mb-10">
            <h2 className="text-2xl font-bold text-gray-800 dark:text-white mb-4">7. Disclaimer of Warranties</h2>
          ...
          <section className="mb-10">
            <h2 className="text-2xl font-bold text-gray-800 dark:text-white mb-4">8. Limitation of Liability</h2>
            <div className="bg-red-50 dark:bg-red-900/20 rounded-xl p-6 border border-red-200 dark:border-red-800">
              ...
              <ul className="text-gray-600 dark:text-gray-300 space-y-3">
                <li className="flex items-start gap-2">
                  ...
                  <span><strong className="text-gray-800 dark:text-white">Outdoor Activities:</strong> Information about mountains, hiking trails, ski resorts, and other outdoor destinations is for general reference. Always verify conditions, obtain proper permits, and exercise appropriate caution. We are not responsible for injuries, accidents, or deaths resulting from reliance on our data.</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-red-500 mt-1">•</span>
                  <span><strong className="text-gray-800 dark:text-white">Travel Decisions:</strong> We are not responsible for travel decisions made based on the Service, including but not limited to flight bookings, accommodations, or itinerary planning.</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-red-500 mt-1">•</span>
                  <span><strong className="text-gray-800 dark:text-white">Data Loss:</strong> We are not liable for loss of your travel tracking data due to technical issues, account deletion, or service discontinuation.</span>
                </li>
              </ul>
          ...
          <section className="mb-10">
            <h2 className="text-2xl font-bold text-gray-800 dark:text-white mb-4">10. Intellectual Property</h2>
            <p className="text-gray-600 dark:text-gray-300 mb-4">
